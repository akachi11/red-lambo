...
import logo from '../images/lambo-logo.png';
...
const Navbar = () => {
  ...
  return (
    <nav className='w-full flex md:justify-center justify-between items-center p-4'>
      <div className="pt-2 md:flex-[0.5] flex-initial justify-center items-center">
      ...
      <ul className='text-white md:flex hidden list-none flex-row justify-betwen items-center flex-initial'>
        ...
        <li className='bg-gradient-to-r from-[#f70c1e] to-[#530018] py-2 px-7 mx-4 rounded-full cursor-pointer hover:bg-[#2546bd]'>
          Login
        </li>
      </ul>
